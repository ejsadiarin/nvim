...
return {
    {
        ...
        opts = function(_, opts)
            ...
            config.defaults.keymap.fzf["ctrl-m"] = "select-all+accept"
        ...
        keys = {
            ...
            -- find
            { "<leader>fb", "<cmd>FzfLua buffers sort_mru=true sort_lastused=true<cr>", desc = "[b]uffers" },
            ...
            { "<leader>sb", "<cmd>FzfLua grep_curbuf<cr>", desc = "[b]uffer" },
            ...
            { "<leader>sw", LazyVim.pick("grep_cword"), desc = "[w]ord (Root Dir)" },
            { "<leader>sW", LazyVim.pick("grep_cword", { root = false }), desc = "[W]ord (cwd)" },
            { "<leader>sw", LazyVim.pick("grep_visual"), mode = "v", desc = "[w]Selection (Root Dir)" },
            { "<leader>sW", LazyVim.pick("grep_visual", { root = false }), mode = "v", desc = "[W]Selection (cwd)" },
            { "<leader>uC", LazyVim.pick("colorschemes"), desc = "[C]olorscheme with Preview" },
            {
                "<leader>ss",
                function()
